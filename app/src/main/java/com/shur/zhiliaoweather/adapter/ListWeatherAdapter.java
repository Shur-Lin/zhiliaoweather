...
import com.shur.zhiliaoweather.entity.WeatherSubEntity;
...
public class ListWeatherAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView != null) {
            convertView = mInflater.inflate(R.layout.item_listview_tomorrow, null);
        }
        // 日期
        ...
        // 白天天气图片
        CHImageView list_day_picture = (CHImageView) convertView.findViewById(R.id.list_day_picture);
        String dayp = tweather.get(position).getDayPictureUrl();
        list_day_picture.loadImage(dayp);
        // 夜晚天气图片
        CHImageView list_night_picture = (CHImageView) convertView.findViewById(R.id.list_night_picture);
        String nightp = tweather.get(position).getNightPictureUrl();
        list_night_picture.loadImage(nightp);
        // 天气情况
        TextView list_weather = (TextView) convertView.findViewById(R.id.list_weather);
        list_weather.setText(tweather.get(position).getWeather());
        // 温度
        TextView list_temperature = (TextView) convertView.findViewById(R.id.list_temperature);
        ...
        // 风力
        TextView list_wind = (TextView) convertView.findViewById(R.id.list_wind);
