...
public class GridTodayCAdapter extends BaseAdapter {
    ...
    private int[] resours = {
            ...
            R.drawable.ic_todaycan_carwash,
            R.drawable.ic_todaycan_tour,
            R.drawable.ic_todaycan_coldl,
            R.drawable.ic_todaycan_sport,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_gridview_todaycan, parent, false);
        }
